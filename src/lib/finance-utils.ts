// Pure finance utilities — CLIENT-SAFE (no db / firebase imports)
// Import this from client components ("use client") instead of ./finance.
...
export function detectOverspending(
  currentExpenses: { category: string; amount: number; date: Date; note: string | null; recurring?: boolean }[],
