...
import {
  ...
  TrendingUp, Home, CalendarDays, Receipt, Trophy, Wallet, Landmark, Flame, Activity, Globe, RefreshCw, CreditCard, GitCompare,
} from "lucide-react";
...
export function CommandPalette({ open, onOpenChange, onNavigate, onQuickAdd }: CommandPaletteProps) {
  ...
  const navItems: { id: ViewType; label: string; icon: any; desc: string }[] = [
    ...
    { id: "currency", label: "Currency Converter", icon: Globe, desc: "Multi-currency rates" },
    { id: "scenario", label: "Scenario Simulator", icon: GitCompare, desc: "What-if analysis" },
